...
class JLogicalOrOp extends JBooleanBinaryExpression {
     ...
     */
    /*
        Branch to targetLabel when arg1 || arg2 is true:

            Branch to targetLabel if arg1 is true
            Branch to targetLabel if arg2 is true

        Branch to targetLabel when arg1 || arg2 is false:
            Branch to skip if arg1 is true
            Branch to targetLabel if arg2 is false
