...
class JMethodDeclaration extends JAST implements JMember {
    ...
    /**
     * Exceptions thrown, in JVM form.
     */
    private ArrayList<String> exceptionsJVM;
    ...
    public JAST analyze(Context context) {
        ...
        for (JFormalParameter param : params) {
            ...
            // Long and Double get two offsets, so make a call to nextOffset
        ...
        // Store exceptions in JVM form
        this.exceptionsJVM = new ArrayList<>();
        if(exceptions != null) {
            for(TypeName typeName: exceptions) {
                exceptionsJVM.add(typeName.jvmName());
            }
        }
        return this;
    }
    ...
    public void partialCodegen(Context context, CLEmitter partial) {
        partial.addMethod(mods, name, descriptor, this.exceptionsJVM, false);
    ...
    public void codegen(CLEmitter output) {
        output.addMethod(mods, name, descriptor, this.exceptionsJVM, false);
        if (body != null) {
            body.codegen(output);
        }
        if (returnType == Type.VOID) {
