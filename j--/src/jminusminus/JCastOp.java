...
class Conversions {
    ...
    public Conversions() {
        ...
        // Widening
        put(Type.CHAR, Type.INT, Converter.WidenReference);
        put(Type.CHAR, Type.LONG, Converter.WidenReference);
        put(Type.CHAR, Type.DOUBLE, Converter.WidenReference);
        put(Type.INT,Type.DOUBLE, new I2D());
        put(Type.INT,Type.LONG, new I2J());
        put(Type.LONG, Type.DOUBLE, new J2D());

        // Narrowing.
        put(Type.INT, Type.CHAR, new I2C());
        put(Type.DOUBLE, Type.LONG, new D2J());
        put(Type.DOUBLE, Type.INT, new D2I());
        put(Type.LONG, Type.INT, new J2I());
 ...
 */
class D2J implements Converter {
    /**
     * {@inheritDoc}
     */
    public void codegen(CLEmitter output) {
 ...
 */
class J2I implements Converter {
    /**
     * {@inheritDoc}
     */
    public void codegen(CLEmitter output) {
 ...
 *
 */
class I2J implements Converter {
 ...
 */
class J2D implements Converter {
