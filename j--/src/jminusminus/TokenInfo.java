...
enum TokenKind {
    ...
    MINUS("-"), PLUS("+"), PLUS_ASSIGN("+="), STAR("*"),DIVIDE("/"), REMAINDER("%"), BNOT("~"), BINCOR("|"),
    BEXCOR("^"), BAND("&"), ALSHIFT("<<"), ARSHIFT(">>"), LRSHIFT(">>>"), TERNIF("?"),TERNELSE(":"), DIV_ASSIGN("/="),
    NEQUAL("!="), MINUS_ASSIGN("-="), MULT_ASSIGN("*="), MOD_ASSIGN("%="), ARSHIFT_ASSIGN(">>="), LRSHIFT_ASSIGN(">>>="),
    GE(">="), ALSHIFT_ASSIGN("<<="), LT("<"), BEXCOR_ASSIGN("^="), BINCOR_ASSIGN("|="),LOR("||"), BAND_ASSIGN("&="),
